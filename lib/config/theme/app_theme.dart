...
sealed class AppTheme {
  ...
  static ThemeData light = FlexThemeData.light(
    ...
    colors: const FlexSchemeColor(
      // Custom colors
      primary: Color(0xFF0064B0),
      primaryContainer: Color(0xFFFFFFFF),
      primaryLightRef: Color(0xFF0064B0),
      secondary: Color(0xFF0064B0),
      secondaryContainer: Color(0xFF0064B0),
      secondaryLightRef: Color(0xFF0064B0),
      tertiary: Color(0xFF0064B0),
      tertiaryContainer: Color(0xFFFFFFFF),
      tertiaryLightRef: Color(0xFF0064B0),
      appBarColor: Color(0xFF0064B0),
