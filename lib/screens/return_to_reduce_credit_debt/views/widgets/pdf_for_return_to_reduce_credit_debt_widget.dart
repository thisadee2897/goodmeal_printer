...
class PDFGeneratorReturnToReduceCreditDebt {
                  ...
                  pw.Padding(
                    ...
                    child: pw.SizedBox(
                      ...
                      child: pw.Column(
                        ...
                        mainAxisAlignment: pw.MainAxisAlignment.start,
                        children: [
                          pw.Text('ส่งคืนลดหนี้เงินเชื่อ / Credit Note', style: textStyleBold.copyWith(fontSize: 20)),
                              ...
                              children: [
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child:
                                        pw.Text(num.parse(dt[index].creditnoteDtNetamnt ?? '0').digits(2), textAlign: pw.TextAlign.end, style: textStyleNormal),
                                  ),
                                ),
                              ],
                            ),
                              ...
                              pw.Expanded(
                                ...
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text("${hd.creditnoteHdCreditday.digits(0)} วัน", style: textStyleBold),
                                  ],
                                ),
                              ),
                              pw.Expanded(
