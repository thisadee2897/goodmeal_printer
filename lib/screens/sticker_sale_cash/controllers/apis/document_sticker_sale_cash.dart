...
class DocumentStickerSaleCashApi {
  final Ref ref;
  DocumentStickerSaleCashApi({required this.ref});
...
final apiDocumentStickerSaleCash = Provider<DocumentStickerSaleCashApi>((ref) => DocumentStickerSaleCashApi(ref: ref));
