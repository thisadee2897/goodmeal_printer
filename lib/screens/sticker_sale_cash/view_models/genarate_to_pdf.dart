...
final genarateToPDFStickerSaleCashProvider = StateNotifierProvider<GenaratePDFSaleCashNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFSaleCashNotifier(),
);

class GenaratePDFSaleCashNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFSaleCashNotifier() : super(AsyncValue.data(pw.Document())) {
