...
import '../controllers/providers/document_good_receive_cash_dt.dart';

class GoodReceiveCashScreen extends ConsumerWidget {
  const GoodReceiveCashScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    Uint8List? filePdf = ref.watch(filePdfGoodReceiveCashViewProvider);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          FilledButton.icon(
            onPressed: () async {
              var pdfFile = ref.read(filePdfGoodReceiveCashProvider);
