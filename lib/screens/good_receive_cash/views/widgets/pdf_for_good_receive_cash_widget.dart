...
class PDFGeneratorGoodReceiveCash {
  Future<pw.Page> generate({required DocumentReceiveGoodModel hd, required List<DocumentReceiveGoodDTModel> dt, required CompanyModel company}) async {
                  ...
                  pw.Padding(
                    ...
                    child: pw.SizedBox(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          pw.Text(
                            'รับสินค้าเงินสด / Good receive cash',
                            style: pw.TextStyle(
                              font: font,
                              color: PdfColors.black,
                              fontSize: 20,
                              ...
                              children: [
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      dt[index].receiveDtListno.digits(0),
                                      textAlign: pw.TextAlign.center,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      "${dt[index].receiveDtProductBarcodeCode}",
                                      textAlign: pw.TextAlign.start,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      num.parse(dt[index].receiveDtNetamnt ?? '0').digits(2),
                                      textAlign: pw.TextAlign.end,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                child: pw.Row(
                                  ...
                                  children: [
                                    ...
                                    pw.Padding(
                                      padding: const pw.EdgeInsets.only(right: 10),
                                      child: pw.Text(
                                        num.parse(hd.receiveHdAmount ?? '0').digits(2),
                            ...
                            children: [
                              pw.Column(
                                ...
                                children: [
                                  ...
                                  pw.Text(NumberToThaiWords.convert(double.parse(hd.receiveHdNetamnt ?? '0')), style: textStyleBold),
                                ],
                              ),
                              pw.Padding(
                                padding: const pw.EdgeInsets.only(right: 10),
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(double.parse(hd.receiveHdNetamnt ?? '0').digits(2), style: textStyleBold),
                                  ],
                                ),
                              ),
                            ],
                                    ...
                                    children: [
                                      ...
                                      pw.Row(
                                        ...
                                        children: [
                                          pw.Row(
                                            children: [
                                              pw.SvgImage(svg: num.parse(hd.receiveHdCashAmount ?? '0') > 0 ? svgTrue : svgFasle),
                                              pw.SizedBox(width: 5),
                                          ...
                                          pw.Padding(
                                            padding: const pw.EdgeInsets.only(right: 10),
                                            child: pw.Text(num.parse(hd.receiveHdCashAmount ?? '0').digits(2), style: textStyleBold),
                                          ),
                                        ],
                                      ),
                                      pw.Row(
                                        ...
                                        children: [
                                          pw.Row(
                                            children: [
                                              pw.SvgImage(svg: num.parse(hd.receiveHdTransferAmount ?? '0') > 0 ? svgTrue : svgFasle),
                                              pw.SizedBox(width: 5),
                                          ...
                                          pw.Padding(
                                            padding: const pw.EdgeInsets.only(right: 10),
                                            child: pw.Text(num.parse(hd.receiveHdTransferAmount ?? '0').digits(2), style: textStyleBold),
                                          ),
                                        ],
                                      ),
                                      // pw.Row(
                                      ...
                                      //     pw.Row(
                                      //       children: [
                                      //         pw.SvgImage(svg: num.parse(hd.receiveHdCreditAmount ?? '0') > 0 ? svgTrue : svgFasle),
                                      //         pw.SizedBox(width: 5),
                                      ...
                                      //     pw.Padding(
                                      //       padding: const pw.EdgeInsets.only(right: 10),
                                      //       child: pw.Text(num.parse(hd.receiveHdCreditAmount ?? '0').digits(2), style: textStyleBold),
                                      //     ),
                                      //   ],
                                      // ),
                                      // pw.Row(
                                      ...
                                      //     pw.Row(
                                      //       children: [
                                      //         pw.SvgImage(svg: num.parse(hd.receiveHdVoucherAmount ?? '0') > 0 ? svgTrue : svgFasle),
                                      //         pw.SizedBox(width: 5),
                                      ...
                                      //     pw.Padding(
                                      //       padding: const pw.EdgeInsets.only(right: 10),
                                      //       child: pw.Text(num.parse(hd.receiveHdVoucherAmount ?? '0').digits(2), style: textStyleBold),
                                      //     ),
                                      //   ],
                                      // ),
                                    ],
                                  ...
                                  children: [
                                    ...
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(
                                            num.parse(hd.receiveHdTotalexcludeamnt ?? '0').digits(2),
                                            style: textStyleBold,
                                          ),
                                        ),
                                      ],
                                    ...
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(
                                            num.parse(hd.receiveHdBaseamnt ?? '0').digits(2),
                                            style: textStyleBold,
                                          ),
                                        ),
                                      ],
                                    ...
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(
                                            num.parse(hd.receiveHdVatamnt ?? '0').digits(2),
                                            style: textStyleBold,
                                          ),
                                        ),
                                      ],
                                    ...
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.receiveHdNetamnt ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                  ],
            ...
            pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Text("${hd.receiveHdRemark}", style: textStyleNormal),
                ],
              ),
            )
          ],
