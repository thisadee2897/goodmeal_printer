...
import '../controllers/providers/document_inventory_adjust_dt.dart';

class InventoryAdjustScreen extends ConsumerWidget {
  const InventoryAdjustScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    Uint8List? filePdf = ref.watch(filePdfInventoryAdjustViewProvider);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          FilledButton.icon(
            onPressed: () async {
              var pdfFile = ref.read(filePdfInventoryAdjustProvider);
