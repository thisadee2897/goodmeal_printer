...
final genarateToPDFReceivableCashProvider = StateNotifierProvider<GenaratePDFReceivableCashNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFReceivableCashNotifier(),
);

class GenaratePDFReceivableCashNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFReceivableCashNotifier() : super(AsyncValue.data(pw.Document())) {
