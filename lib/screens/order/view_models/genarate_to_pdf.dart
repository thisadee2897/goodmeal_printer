...
final genarateToPDFOrderProvider = StateNotifierProvider<GenaratePDFOrderNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFOrderNotifier(),
);

class GenaratePDFOrderNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFOrderNotifier() : super(AsyncValue.data(pw.Document())) {
