...
class PDFGeneratorOrder {
  Future<pw.Page> generate({required DocumentOrderModel hd, required List<DocumentOrderDTModel> dt, required CompanyModel company}) async {
                  ...
                  pw.Padding(
                    ...
                    child: pw.SizedBox(
                      ...
                      child: pw.Column(
                        ...
                        mainAxisAlignment: pw.MainAxisAlignment.start,
                        children: [
                          pw.Text('ใบสั่งขาย/SALE ORDER', style: textStyleBold.copyWith(fontSize: 20)),
                              ...
                              pw.SizedBox(
                                ...
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(hd.orderHdDocuno.toString(), style: textStyleBold),
                                  ],
                                ),
                              ),
                              pw.SizedBox(
                                ...
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(hd.orderHdDocudate.dateTHFormApi, style: textStyleBold),
                                  ],
                                ),
                              ),
                            ],
                              ...
                              children: [
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      dt[index].orderDtListno.digits(0),
                                      textAlign: pw.TextAlign.center,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    ...
                                    child: pw.Text(
                                      ...
                                      "${dt[index].orderDtProductBarcodeCode}",
                                      textAlign: pw.TextAlign.start,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.Expanded(
                                  child: pw.Padding(
                                    ...
                                    child: pw.Text(
                                      ...
                                      "${dt[index].orderDtProductBarcodeName}",
                                      textAlign: pw.TextAlign.start,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      num.parse(dt[index].orderDtPrice ?? '0').digits(2),
                                      textAlign: pw.TextAlign.end,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      num.parse(dt[index].orderDtDiscount ?? '0').digits(2),
                                      textAlign: pw.TextAlign.end,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      num.parse(dt[index].orderDtNetamnt ?? '0').digits(2),
                                      textAlign: pw.TextAlign.end,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                child: pw.Row(
                                  ...
                                  children: [
                                    ...
                                    pw.Padding(
                                      padding: const pw.EdgeInsets.only(right: 10),
                                      child: pw.Text(
                                        num.parse(hd.orderHdAmount ?? '0').digits(2),
                            ...
                            children: [
                              pw.Column(
                                ...
                                children: [
                                  ...
                                  pw.Text(NumberToThaiWords.convert(double.parse(hd.orderHdNetamount ?? '0')), style: textStyleBold),
                                ],
                              ),
                              pw.Padding(
                                padding: const pw.EdgeInsets.only(right: 10),
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(double.parse(hd.orderHdNetamount ?? '0').digits(2), style: textStyleBold),
                                  ],
                                ),
                              ),
                            ],
                                  ...
                                  children: [
                                    ...
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.orderHdBaseamnt ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.orderHdVatamnt ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.orderHdNetamount ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                  ],
              ...
              children: [
                ...
                pw.SizedBox(
                  ...
                  child: pw.Column(
                    ...
                    crossAxisAlignment: pw.CrossAxisAlignment.center,
                    children: [
                      pw.Text("ผู้จัดทำใบสั่งขาย", style: textStyleNormal),
                      pw.SizedBox(height: 10),
                      pw.Text('...........................................................', style: textStyleNormal),
                      pw.Text("(${hd.fullname})", style: textStyleNormal),
                      pw.Text(hd.orderHdDocudate.dateTHFormApi, style: textStyleNormal),
                    ],
                  ),
                ),
              ],
