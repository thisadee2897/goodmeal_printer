...
class FullTaxInvoiceApi {
  ...
  Future<List<FullTaxInvoiceModel>> get(Map<String, dynamic> body) async {
    ...
    print("FullTaxInvoiceApi response: $data");
...
final apiFullTaxInvoice = Provider<FullTaxInvoiceApi>(
  (ref) => FullTaxInvoiceApi(ref: ref),
);
  ...
  return [
    {
      ...
      "header": {
        ...
        "company_address":
            "856/68 ถนนพระราม 9 แขวงสวนหลวง เขตสวนหลวง กรุงเทพมหานคร 10250",
        "company_phone_number": "02-6361566",
        "company_tax_id": "0155661444399",
        "customer_name": "บริษัท ทรัพย์มั่งมี ศรีสุข จำกัด",
        "customer_address":
            "892 ถนนรำมค ำแหง แขวงวังทองทลำง เขตวังทองหลำง กรุงเทพมหานคร 10310 ",
      ...
      "details": [
        {
          "list_no": 1,
          "item_name": "ค่าอาหารและเครื่องดื่ม",
          "amount": 3105.00,
        },
    ...
    },
    {
      ...
      "header": {
        ...
        "customer_address":
            "892 ถนนรำมค ำแหง แขวงวังทองทลำง เขตวังทองหลำง กรุงเทพมหำนคร 10310 ",
        "customer_phone_number": "0958644567",
        "customer_tax_id": "0105566144888",
