...
class PDFGeneratorFullTaxInvoice {
  Future<pw.Page> generate({required FullTaxInvoiceModel dt, required String type}) async {
    ...
    return pw.Page(
      ...
      margin: const pw.EdgeInsets.only(left: 10, right: 10, top: 30, bottom: 10),
