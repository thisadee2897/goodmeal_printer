...
final genarateToPDFFullTaxInvoiceProvider = StateNotifierProvider<GenaratePDFFullTaxInvoiceNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFFullTaxInvoiceNotifier(),
);

class GenaratePDFFullTaxInvoiceNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFFullTaxInvoiceNotifier() : super(AsyncValue.data(pw.Document())) {
