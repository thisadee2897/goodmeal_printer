...
final genarateToPDFReturnProductCreditProvider = StateNotifierProvider<GenaratePDFReturnProductCreditNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFReturnProductCreditNotifier(),
);

class GenaratePDFReturnProductCreditNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFReturnProductCreditNotifier() : super(AsyncValue.data(pw.Document())) {
