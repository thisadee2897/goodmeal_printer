...
class PDFGeneratorReturnToReduceCashDebt {
  Future<pw.Page> generate({required DocumentCreditNoteModel hd, required List<DocumentCreditNoteDTModel> dt, required CompanyModel company}) async {
                  ...
                  pw.Padding(
                    ...
                    child: pw.SizedBox(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          pw.Text(
                            'ส่งคืนลดหนี้เงินสด / Credit Note',
                            style: pw.TextStyle(
                              font: fontBold,
                              color: PdfColors.black,
                              fontSize: 20,
                              ...
                              pw.SizedBox(
                                ...
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(hd.creditnoteHdDocuno.toString(), style: textStyleBold),
                                  ],
                                ),
                              ),
                              pw.SizedBox(
                                ...
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(hd.creditnoteHdDocudate.dateTHFormApi, style: textStyleBold),
                                  ],
                                ),
                              ),
                            ],
                              ...
                              children: [
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      dt[index].creditnoteDtListno.digits(0),
                                      textAlign: pw.TextAlign.center,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    ...
                                    child: pw.Text(
                                      maxLines: 1,
                                      overflow: pw.TextOverflow.visible,
                                      "${dt[index].creditnoteDtProductBarcodeCode}",
                                      textAlign: pw.TextAlign.start,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.Expanded(
                                  child: pw.Padding(
                                    ...
                                    child: pw.Text(
                                      maxLines: 1,
                                      overflow: pw.TextOverflow.visible,
                                      "${dt[index].creditnoteDtProductBarcodeName}",
                                      textAlign: pw.TextAlign.start,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      num.parse(dt[index].creditnoteDtNetamnt ?? '0').digits(2),
                                      textAlign: pw.TextAlign.end,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                child: pw.Row(
                                  ...
                                  children: [
                                    ...
                                    pw.Padding(
                                      padding: const pw.EdgeInsets.only(right: 10),
                                      child: pw.Text(
                                        num.parse(hd.creditnoteHdAmount ?? '0').digits(2),
                            ...
                            children: [
                              pw.Column(
                                ...
                                children: [
                                  ...
                                  pw.Text(NumberToThaiWords.convert(double.parse(hd.creditnoteHdNetamnt ?? '0')), style: textStyleBold),
                                ],
                              ),
                              pw.Padding(
                                padding: const pw.EdgeInsets.only(right: 10),
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(double.parse(hd.creditnoteHdNetamnt ?? '0').digits(2), style: textStyleBold),
                                  ],
                                ),
                              ),
                            ],
                                    ...
                                    children: [
                                      ...
                                      pw.Row(
                                        ...
                                        children: [
                                          pw.Row(
                                            children: [
                                              pw.SvgImage(svg: num.parse(hd.creditnoteHdCashAmount ?? '0') > 0 ? svgTrue : svgFasle),
                                              pw.SizedBox(width: 5),
                                          ...
                                          pw.Padding(
                                            padding: const pw.EdgeInsets.only(right: 10),
                                            child: pw.Text(
                                              num.parse(hd.creditnoteHdCashAmount ?? '0').digits(2),
                                              style: textStyleBold,
                                            ),
                                          ),
                                        ],
                                      ...
                                      pw.Row(
                                        ...
                                        children: [
                                          pw.Row(
                                            children: [
                                              pw.SvgImage(svg: num.parse(hd.creditnoteHdTransferAmount ?? '0') > 0 ? svgTrue : svgFasle),
                                              pw.SizedBox(width: 5),
                                          ...
                                          pw.Padding(
                                            padding: const pw.EdgeInsets.only(right: 10),
                                            child: pw.Text(num.parse(hd.creditnoteHdTransferAmount ?? '0').digits(2), style: textStyleBold),
                                          ),
                                        ],
                                      ),
                                    ],
                                  ...
                                  children: [
                                    ...
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.creditnoteHdTotalexcludeamnt ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.creditnoteHdBaseamnt ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.creditnoteHdVatamnt ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                    pw.Row(
            ...
            pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Text("${hd.creditnoteHdRemark}", style: textStyleNormal),
                ],
              ),
            ),
          ],
