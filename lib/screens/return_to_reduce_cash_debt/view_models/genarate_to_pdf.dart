...
final genarateToPDFReturnToReduceCashDebtProvider = StateNotifierProvider<GenaratePDFReturnToReduceCashDebtNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFReturnToReduceCashDebtNotifier(),
);

class GenaratePDFReturnToReduceCashDebtNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFReturnToReduceCashDebtNotifier() : super(AsyncValue.data(pw.Document())) {
