...
final genarateToPDFReportHQVatPosttSaleProvider = StateNotifierProvider<GenaratePDFReportHQVatPosttSaleNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFReportHQVatPosttSaleNotifier(),
);

class GenaratePDFReportHQVatPosttSaleNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFReportHQVatPosttSaleNotifier() : super(AsyncValue.data(pw.Document())) {
