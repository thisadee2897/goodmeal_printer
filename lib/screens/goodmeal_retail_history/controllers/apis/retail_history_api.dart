...
class RetailHistoriesApi {
  final Ref ref;
  RetailHistoriesApi({required this.ref});
  final String _path = 'print_retail_history';

  Future<List<RetailHistoryModel>> get(Map<String, dynamic> body) async {
    ...
    debugPrint("RetailHistoriesApi data: $data");
    return data.map((e) => RetailHistoryModel.fromJson(e)).toList();
  }

  // Future<List<RetailHistoryModel>> getDummy(Map<String, dynamic> body) async {
  //   try {
  //     await Future.delayed(const Duration(seconds: 1));
  //     List<Map<String, dynamic>> data = ref.read(dummyDataRetailHistory);
  //     return data.map((e) => RetailHistoryModel.fromJson(e)).toList();
  //   } catch (e, stx) {
...
final apiRetailHistories = Provider<RetailHistoriesApi>(
  (ref) => RetailHistoriesApi(ref: ref),
);

final dummyDataRetailHistory = Provider<List<Map<String, dynamic>>>((ref) {
  return [
    {
      "header": {
        "title": "ใบเสร็จรับเงิน / ใบกำกับภาษี (อย่างย่อ)",
        "company_logo_image_network":
            "https://play-lh.googleusercontent.com/09bryua3mfaR8lVaRZL4ZFmIHYXndC1aYdyrn7NSpPl13YHV-vQ2n0wi0xNk4Wdrft8",
        "company_name": "(UAT) เทสระบบ 1",
        "company_address":
            "99/122 ห้อง D-04  แขวงทุ่งสองห้อง เขตหลักสี่ กรุงเทพมหานคร 10210",
      ...
      "details": [
        {
          "list_no": 1,
          "item_name": "Ushi Buffet (ผู้ใหญ่) (บุฟเฟ่ต์)",
          "unit_price": 488,
          "quantity": 2,
          "amount": 976,
        },
        {
          "list_no": 2,
          "item_name": "Ushi Buffet (เด็ก) (บุฟเฟ่ต์)",
          "unit_price": 240,
          "quantity": 1,
          "amount": 240,
        },
        {
          "list_no": 3,
          "item_name": "ปลาหมึกบั้ง (บุฟเฟ่ต์)",
          "unit_price": 0,
          "quantity": 4,
          "amount": 0,
        },
        {
          "list_no": 4,
          "item_name": "เครื่องดื่ม Buffet (ผู้ใหญ่) (บุฟเฟ่ต์)",
          "unit_price": 39,
          "quantity": 1,
          "amount": 39,
        },
        {
          "list_no": 5,
          "item_name": "ฺBottle น้ำแดงแฟนต้า (บุฟเฟ่ต์)",
          "unit_price": 0,
          "quantity": 3,
          "amount": 0,
        },
        {
          "list_no": 6,
          "item_name": "ฺBottle น้ำโค้ก Buffet 1111 (บุฟเฟ่ต์)",
          "unit_price": 0,
          "quantity": 3,
          "amount": 0,
        },
      ...
      "footer": {
        ...
        "categories": [
          {
            "category_name": "(B) เครื่องดื่ม Refill",
            "quantity": 6,
            "amount": 0,
          },
    ...
    },
    {
      ...
      "details": [
        {
          "list_no": 1,
          "item_name": "คินส์คนเดียว+โค้ก 1 กระป๋อง",
          "unit_price": 220,
          "quantity": 3,
          "amount": 660,
        },
        ...
        {
          "list_no": 3,
          "item_name": "ข้าวผัดกระเทียม (Option)",
          "unit_price": 0,
          "quantity": 3,
          "amount": 0,
        },
        {
          "list_no": 4,
          "item_name": "เนื้อเสือร้องไห้ (Option)",
          "unit_price": 59,
          "quantity": 6,
          "amount": 354,
        },
