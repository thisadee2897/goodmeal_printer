...
class PDFGeneratorRetailHistory {
  Future<pw.Page> generate({
    required RetailHistoryModel dt,
                              ...
                              pw.SizedBox(
                                ...
                                child: pw.Row(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(
                                      dt.header!.docuDate.timeOnlyTHFormApi,
                                      style: textStyleNormal,
                                    ),
                                  ],
                                ),
                  ...
                  if (showFooter)
                    pw.Column(
                      children: [
                        ...
                        if (showDiscounts)
                          ...List.generate(dt.footer!.discounts!.length, (
                            index,
                          ) {
                                      ...
                                      children: [
                                        pw.SizedBox(
                                          ...
                                          child: pw.Padding(
                                            ...
                                            child: pw.Text(
                                              itemDiscount.discountValue.digits(
                                                2,
                                              ),
                                              textAlign: pw.TextAlign.end,
                                              style: textStyleNormal,
                        ...
                        if (dt.footer!.paymentMethods!.isNotEmpty &&
                            showPaymentMethods)
                          ...List.generate(dt.footer!.paymentMethods!.length, (
                            index,
                          ) {
                        ...
                        if (dt.footer!.categories!.isNotEmpty && showCategories)
                          ...List.generate(dt.footer!.categories!.length, (
                            index,
                          ) {
                                    ...
                                    children: [
                                      pw.SizedBox(
                                        ...
                                        child: pw.Padding(
                                          ...
                                          child: pw.Text(
                                            dt.footer!.totalCategoriesAmount
                                                .digits(2),
                                            textAlign: pw.TextAlign.end,
                                            style: textStyleBold.copyWith(
                                              decoration:
                        ...
                        if (dt.footer!.points!.isNotEmpty && showPoints)
                          ...List.generate(dt.footer!.points!.length, (index) {
