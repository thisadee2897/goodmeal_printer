...
import '../controllers/providers/check_balance.dart';

class CheckBalanceScreen extends ConsumerWidget {
  const CheckBalanceScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    Uint8List? filePdf = ref.watch(filePdfCheckBalanceViewProvider);
    final hd = ref.watch(checkBalanceProvider);
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          FilledButton.icon(
            onPressed: () async {
              var pdfFile = ref.read(filePdfCheckBalanceProvider);
