...
class PDFGeneratorGoodReceiveCredit {
                  ...
                  pw.Padding(
                    ...
                    child: pw.SizedBox(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          pw.Text(
                            'รับสินค้าเงินเชื่อ / Good receive credit',
                            style: pw.TextStyle(
                              font: font,
                              color: PdfColors.black,
                              fontSize: 20,
                                ...
                                child: pw.Padding(
                                  ...
                                  child: pw.Column(
                                    ...
                                    children: [
                                      ...
                                      pw.Text("${hd.receiveHdCreditday.digits(0)} วัน", style: textStyleBold),
                                    ],
                                  ),
                                ),
                              ),
                                  ...
                                  children: [
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.receiveHdTotalexcludeamnt ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.receiveHdBaseamnt ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                    pw.Row(
                                      ...
                                      children: [
                                        ...
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.receiveHdVatamnt ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                    pw.Row(
