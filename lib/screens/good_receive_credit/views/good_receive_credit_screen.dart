...
import '../controllers/providers/document_good_receive_credit_dt.dart';

class GoodReceiveCreditScreen extends ConsumerWidget {
  const GoodReceiveCreditScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    Uint8List? filePdf = ref.watch(filePdfGoodReceiveCreditViewProvider);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          FilledButton.icon(
            onPressed: () async {
              var pdfFile = ref.read(filePdfGoodReceiveCreditProvider);
