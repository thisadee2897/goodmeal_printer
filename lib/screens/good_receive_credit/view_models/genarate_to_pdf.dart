...
final genarateToPDFGoodReceiveCreditProvider = StateNotifierProvider<GenaratePDFGoodReceiveCreditNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFGoodReceiveCreditNotifier(),
);

class GenaratePDFGoodReceiveCreditNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFGoodReceiveCreditNotifier() : super(AsyncValue.data(pw.Document())) {
