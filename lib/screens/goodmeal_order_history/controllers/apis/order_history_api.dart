...
class OrderHistoriesApi {
  ...
  final String _path = 'print_order_history';

  Future<List<OrderHistoryModel>> get(Map<String, dynamic> body) async {
  ...
  Future<List<OrderHistoryModel>> getDummy(Map<String, dynamic> body) async {
    try {
      await Future.delayed(const Duration(seconds: 1));
      List<Map<String, dynamic>> data = ref.read(dummyDataOrderHistory);
      return data.map((e) => OrderHistoryModel.fromJson(e)).toList();
    } catch (e, stx) {
...
final apiOrderHistories = Provider<OrderHistoriesApi>(
  (ref) => OrderHistoriesApi(ref: ref),
);

final dummyDataOrderHistory = Provider<List<Map<String, dynamic>>>((ref) {
  return [
    {
      "header": {
