...
class OrderHistoriesNotifier extends StateNotifier<AsyncValue<List<SalehdAllPreviewModel>>> {
  ...
  Future<void> get({required Map<String, dynamic> body}) async {
    ...
    state = await AsyncValue.guard(() async {
      ...
      return [];
      // List<SalehdAllPreviewModel> response = await ref.read(apiOrderHistories).get(body);
...
final orderHistoriesProvider = StateNotifierProvider<OrderHistoriesNotifier, AsyncValue<List<SalehdAllPreviewModel>>>(
