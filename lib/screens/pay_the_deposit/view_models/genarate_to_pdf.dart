...
final genarateToPDFPayTheDepositProvider = StateNotifierProvider<GenaratePDFPayTheDepositNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFPayTheDepositNotifier(),
);

class GenaratePDFPayTheDepositNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFPayTheDepositNotifier() : super(AsyncValue.data(pw.Document())) {
