...
import '../controllers/providers/document_pay_the_deposit_dt.dart';

class PayTheDepositScreen extends ConsumerWidget {
  const PayTheDepositScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    Uint8List? filePdf = ref.watch(filePdfPayTheDepositViewProvider);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          FilledButton.icon(
            onPressed: () async {
              var pdfFile = ref.read(filePdfPayTheDepositProvider);
