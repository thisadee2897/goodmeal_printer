...
final genarateToPDFPurchaseOrderProvider = StateNotifierProvider<GenaratePDFPurchaseOrderNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFPurchaseOrderNotifier(),
);

class GenaratePDFPurchaseOrderNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFPurchaseOrderNotifier() : super(AsyncValue.data(pw.Document())) {
