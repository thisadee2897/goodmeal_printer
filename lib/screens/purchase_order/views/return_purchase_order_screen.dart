...
import '../controllers/providers/document_purchase_order_dt.dart';
...
class PurchaseOrderScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    Uint8List? filePdf = ref.watch(filePdfPurchaseOrderViewProvider);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          FilledButton.icon(
            onPressed: () async {
              var pdfFile = ref.read(filePdfPurchaseOrderProvider);
