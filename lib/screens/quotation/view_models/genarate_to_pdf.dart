...
final genarateToPDFQuotationProvider = StateNotifierProvider<GenaratePDFQuotationNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFQuotationNotifier(),
);

class GenaratePDFQuotationNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFQuotationNotifier() : super(AsyncValue.data(pw.Document())) {
