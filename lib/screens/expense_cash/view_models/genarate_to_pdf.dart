...
final genarateToPDFExpenseCashProvider = StateNotifierProvider<GenaratePDFExpenseCashNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFExpenseCashNotifier(),
);

class GenaratePDFExpenseCashNotifier extends StateNotifier<AsyncValue<pw.Document>> {
