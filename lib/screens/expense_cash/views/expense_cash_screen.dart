...
import '../controllers/providers/document_expense_cash_dt.dart';

class ExpenseCashScreen extends ConsumerWidget {
  const ExpenseCashScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    Uint8List? filePdf = ref.watch(filePdfExpenseCashViewProvider);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          FilledButton.icon(
            onPressed: () async {
              var pdfFile = ref.read(filePdfExpenseCashProvider);
