                                    ...
                                    children: [
                                      ...
                                      pw.Row(
                                        ...
                                        children: [
                                          ...
                                          pw.Padding(
                                            padding: const pw.EdgeInsets.only(right: 10),
                                            child: pw.Text(num.parse(hd.saleHdCashAmount ?? '0').digits(2), style: textStyleBold),
                                          ),
                                        ],
                                      ),
                                      pw.Row(
                                        ...
                                        children: [
                                          ...
                                          pw.Padding(
                                            padding: const pw.EdgeInsets.only(right: 10),
                                            child: pw.Text(num.parse(hd.saleHdTransferAmount ?? '0').digits(2), style: textStyleBold),
                                          ),
                                        ],
                                      ),
                                      pw.Row(
                                        ...
                                        children: [
                                          ...
                                          pw.Padding(
                                            padding: const pw.EdgeInsets.only(right: 10),
                                            child: pw.Text(num.parse(hd.saleHdCreditAmount ?? '0').digits(2), style: textStyleBold),
                                          ),
                                        ],
                                      ),
                                      pw.Row(
                                        ...
                                        children: [
                                          ...
                                          pw.Padding(
                                            padding: const pw.EdgeInsets.only(right: 10),
                                            child: pw.Text(num.parse(hd.saleHdVoucherAmount ?? '0').digits(2), style: textStyleBold),
                                          ),
                                        ],
                                      ),
                                    ],
                                ...
                                child: pw.Column(
                                  children: [
                                    ...
                                    pw.Row(
                                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                                      children: [
                                        pw.Text('หัก ณ ที่จ่าย', style: textStyleBold),
                                        pw.Padding(
                                          padding: const pw.EdgeInsets.only(right: 10),
                                          child: pw.Text(num.parse(hd.saleHdWhtAmount ?? '0').digits(2), style: textStyleBold),
                                        ),
                                      ],
                                    ),
                                    pw.Row(
