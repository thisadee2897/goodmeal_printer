...
final genarateToPDFExpenseCreditProvider = StateNotifierProvider<GenaratePDFExpenseCreditNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFExpenseCreditNotifier(),
);

class GenaratePDFExpenseCreditNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFExpenseCreditNotifier() : super(AsyncValue.data(pw.Document())) {
