...
final genarateToPDFPurchaseRequestProvider = StateNotifierProvider<GenaratePDFPurchaseRequestNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFPurchaseRequestNotifier(),
);

class GenaratePDFPurchaseRequestNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFPurchaseRequestNotifier() : super(AsyncValue.data(pw.Document())) {
