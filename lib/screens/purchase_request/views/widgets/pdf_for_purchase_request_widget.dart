...
class PDFGeneratorPurchaseRequest {
  Future<pw.Page> generate({required DocumentPurchaseRequestModel hd, required List<DocumentPurchaseRequestDTModel> dt, required CompanyModel company}) async {
                  ...
                  pw.Padding(
                    ...
                    child: pw.SizedBox(
                      ...
                      child: pw.Column(
                        ...
                        mainAxisAlignment: pw.MainAxisAlignment.start,
                        children: [
                          pw.Text('ใบขอสั่งซื้อ / Purchase request', style: textStyleBold.copyWith(fontSize: 20)),
                              ...
                              pw.SizedBox(
                                ...
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(hd.purchaserequestHdDocuno.toString(), style: textStyleBold),
                                  ],
                                ),
                              ),
                              pw.SizedBox(
                                ...
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(hd.purchaserequestHdDocudate.dateTHFormApi, style: textStyleBold),
                                  ],
                                ),
                              ),
                            ],
                              ...
                              children: [
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      dt[index].purchaserequestDtListno.digits(0),
                                      textAlign: pw.TextAlign.center,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    ...
                                    child: pw.Text(
                                      ...
                                      "${dt[index].purchaserequestDtProductBarcodeCode}",
                                      textAlign: pw.TextAlign.start,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      num.parse(dt[index].purchaserequestDtQty ?? '0').digits(2),
                                      textAlign: pw.TextAlign.end,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      num.parse(dt[index].purchaserequestDtPrice ?? '0').digits(2),
                                      textAlign: pw.TextAlign.end,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      num.parse(dt[index].purchaserequestDtDiscount ?? '0').digits(2),
                                      textAlign: pw.TextAlign.end,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                pw.SizedBox(
                                  ...
                                  child: pw.Padding(
                                    padding: const pw.EdgeInsets.only(left: 2, right: 2),
                                    child: pw.Text(
                                      num.parse(dt[index].purchaserequestDtNetamnt ?? '0').digits(2),
                                      textAlign: pw.TextAlign.end,
                                      style: textStyleNormal,
                                    ),
                                  ),
                                ...
                                child: pw.Row(
                                  ...
                                  children: [
                                    ...
                                    pw.Padding(
                                      padding: const pw.EdgeInsets.only(right: 10),
                                      child: pw.Text(
                                        num.parse(hd.purchaserequestHdAmount ?? '0').digits(2),
                            ...
                            children: [
                              pw.Column(
                                ...
                                children: [
                                  ...
                                  pw.Text(NumberToThaiWords.convert(double.parse(hd.purchaserequestHdNetamount ?? '0')), style: textStyleBold),
                                ],
                              ),
                              pw.Padding(
                                padding: const pw.EdgeInsets.only(right: 10),
                                child: pw.Column(
                                  ...
                                  children: [
                                    ...
                                    pw.Text(double.parse(hd.purchaserequestHdNetamount ?? '0').digits(2), style: textStyleBold),
                                  ],
                                ),
                              ),
                            ],
              ...
              children: [
                pw.SizedBox(
                  ...
                  child: pw.Column(
                    ...
                    crossAxisAlignment: pw.CrossAxisAlignment.center,
                    children: [
                      pw.Text("ผู้จัดทำใบขอสั่งซื้อ", style: textStyleNormal),
                      pw.SizedBox(height: 10),
            ...
            pw.Padding(
              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Text("${hd.purchaserequestHdRemark}", style: textStyleNormal),
                ],
              ),
            )
          ],
