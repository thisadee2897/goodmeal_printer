...
import '../controllers/providers/document_inventory_requisition_dt.dart';

class InventoryRequisitionScreen extends ConsumerWidget {
  const InventoryRequisitionScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    Uint8List? filePdf = ref.watch(filePdfInventoryRequisitionViewProvider);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          FilledButton.icon(
            onPressed: () async {
              var pdfFile = ref.read(filePdfInventoryRequisitionProvider);
