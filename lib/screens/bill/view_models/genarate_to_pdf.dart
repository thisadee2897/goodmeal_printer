...
final genarateToPDFBillProvider = StateNotifierProvider<GenaratePDFBillNotifier, AsyncValue<pw.Document>>(
  (ref) => GenaratePDFBillNotifier(),
);

class GenaratePDFBillNotifier extends StateNotifier<AsyncValue<pw.Document>> {
  GenaratePDFBillNotifier() : super(AsyncValue.data(pw.Document())) {
