...
part of 'footer_retail_history_model.dart';
...
FooterRetailHistoryModel _$FooterRetailHistoryModelFromJson(
    Map<String, dynamic> json) {
  return _FooterRetailHistoryModel.fromJson(json);
}

/// @nodoc
mixin _$FooterRetailHistoryModel {
  ...
  /// Serializes this FooterRetailHistoryModel to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of FooterRetailHistoryModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $FooterRetailHistoryModelCopyWith<FooterRetailHistoryModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FooterRetailHistoryModelCopyWith<$Res> {
  factory $FooterRetailHistoryModelCopyWith(FooterRetailHistoryModel value,
          $Res Function(FooterRetailHistoryModel) then) =
      _$FooterRetailHistoryModelCopyWithImpl<$Res, FooterRetailHistoryModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$FooterRetailHistoryModelCopyWithImpl<$Res,
        $Val extends FooterRetailHistoryModel>
    implements $FooterRetailHistoryModelCopyWith<$Res> {
  _$FooterRetailHistoryModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$FooterRetailHistoryModelImplCopyWith<$Res>
    implements $FooterRetailHistoryModelCopyWith<$Res> {
  factory _$$FooterRetailHistoryModelImplCopyWith(
          _$FooterRetailHistoryModelImpl value,
          $Res Function(_$FooterRetailHistoryModelImpl) then) =
      __$$FooterRetailHistoryModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'total_items') num? totalItems,
...
/// @nodoc
class __$$FooterRetailHistoryModelImplCopyWithImpl<$Res>
    extends _$FooterRetailHistoryModelCopyWithImpl<$Res,
        _$FooterRetailHistoryModelImpl>
    implements _$$FooterRetailHistoryModelImplCopyWith<$Res> {
  __$$FooterRetailHistoryModelImplCopyWithImpl(
      _$FooterRetailHistoryModelImpl _value,
      $Res Function(_$FooterRetailHistoryModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$FooterRetailHistoryModelImpl(
      totalItems: freezed == totalItems
          ? _value.totalItems
          : totalItems // ignore: cast_nullable_to_non_nullable
              as num?,
...
/// @nodoc
@JsonSerializable()
class _$FooterRetailHistoryModelImpl implements _FooterRetailHistoryModel {
  const _$FooterRetailHistoryModelImpl(
  ...
  factory _$FooterRetailHistoryModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$FooterRetailHistoryModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'FooterRetailHistoryModel(totalItems: $totalItems, totalAmount: $totalAmount, serviceCharge: $serviceCharge, discounts: $discounts, totalDiscount: $totalDiscount, vatIncluded: $vatIncluded, netAmount: $netAmount, cashReceived: $cashReceived, change: $change, paymentMethods: $paymentMethods, categories: $categories, totalCategoriesAmount: $totalCategoriesAmount, points: $points)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$FooterRetailHistoryModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$FooterRetailHistoryModelImplCopyWith<_$FooterRetailHistoryModelImpl>
      get copyWith => __$$FooterRetailHistoryModelImplCopyWithImpl<
          _$FooterRetailHistoryModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$FooterRetailHistoryModelImplToJson(
      this,
    );
  }
}

abstract class _FooterRetailHistoryModel implements FooterRetailHistoryModel {
  const factory _FooterRetailHistoryModel(
  ...
  factory _FooterRetailHistoryModel.fromJson(Map<String, dynamic> json) =
      _$FooterRetailHistoryModelImpl.fromJson;
