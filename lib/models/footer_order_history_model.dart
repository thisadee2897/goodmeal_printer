...
part 'footer_order_history_model.freezed.dart';
part 'footer_order_history_model.g.dart';

@freezed
class FooterOrderHistoryModel with _$FooterOrderHistoryModel {
  const factory FooterOrderHistoryModel({
  ...
  }) = _FooterOrderHistoryModel;

  factory FooterOrderHistoryModel.fromJson(Map<String, dynamic> json) =>
      _$FooterOrderHistoryModelFromJson(json);
}
