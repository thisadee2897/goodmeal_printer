...
part 'header_retail_history_model.freezed.dart';
part 'header_retail_history_model.g.dart';

@freezed
class HeaderRetailHistoryModel with _$HeaderRetailHistoryModel {
  const factory HeaderRetailHistoryModel({
  ...
  }) = _HeaderRetailrHistoryModel;

  factory HeaderRetailHistoryModel.fromJson(Map<String, dynamic> json) =>
      _$HeaderRetailHistoryModelFromJson(json);
}
