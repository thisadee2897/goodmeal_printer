...
part of 'header_order_history_model.dart';
...
HeaderOrderHistoryModel _$HeaderOrderHistoryModelFromJson(
    Map<String, dynamic> json) {
  return _HeaderOrderHistoryModel.fromJson(json);
}

/// @nodoc
mixin _$HeaderOrderHistoryModel {
  @JsonKey(name: 'title')
  ...
  $HeaderOrderHistoryModelCopyWith<HeaderOrderHistoryModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $HeaderOrderHistoryModelCopyWith<$Res> {
  factory $HeaderOrderHistoryModelCopyWith(HeaderOrderHistoryModel value,
          $Res Function(HeaderOrderHistoryModel) then) =
      _$HeaderOrderHistoryModelCopyWithImpl<$Res, HeaderOrderHistoryModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$HeaderOrderHistoryModelCopyWithImpl<$Res,
        $Val extends HeaderOrderHistoryModel>
    implements $HeaderOrderHistoryModelCopyWith<$Res> {
  _$HeaderOrderHistoryModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$HeaderOrderHistoryModelImplCopyWith<$Res>
    implements $HeaderOrderHistoryModelCopyWith<$Res> {
  factory _$$HeaderOrderHistoryModelImplCopyWith(
          _$HeaderOrderHistoryModelImpl value,
          $Res Function(_$HeaderOrderHistoryModelImpl) then) =
      __$$HeaderOrderHistoryModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'title') String? title,
...
/// @nodoc
class __$$HeaderOrderHistoryModelImplCopyWithImpl<$Res>
    extends _$HeaderOrderHistoryModelCopyWithImpl<$Res,
        _$HeaderOrderHistoryModelImpl>
    implements _$$HeaderOrderHistoryModelImplCopyWith<$Res> {
  __$$HeaderOrderHistoryModelImplCopyWithImpl(
      _$HeaderOrderHistoryModelImpl _value,
      $Res Function(_$HeaderOrderHistoryModelImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$HeaderOrderHistoryModelImpl implements _HeaderOrderHistoryModel {
  const _$HeaderOrderHistoryModelImpl(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$HeaderOrderHistoryModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$HeaderOrderHistoryModelImplCopyWith<_$HeaderOrderHistoryModelImpl>
      get copyWith => __$$HeaderOrderHistoryModelImplCopyWithImpl<
          _$HeaderOrderHistoryModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$HeaderOrderHistoryModelImplToJson(
      this,
    );
  }
}

abstract class _HeaderOrderHistoryModel implements HeaderOrderHistoryModel {
  const factory _HeaderOrderHistoryModel(
